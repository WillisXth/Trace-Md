...
king({
  ...
  try {
    const _0xfcf20b = await fetch("https://api.github.com/repos/franceking1/TRACE-MD");
    ...
    if (_0x20e60b) {
      ...
      await _0x1fb06f.sendMessage(_0x2235f7, "*You can play that video and enjoy ❤️🗿*");
    } else {
