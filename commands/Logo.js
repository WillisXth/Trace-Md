...
king({
  ...
  try {
    if (!_0x17b8db || _0x17b8db == '') {
      _0x1bce4a("*_Example : * " + _0xdbce5a + "naruto TRACE-MD");
      return;
    }
    _0x1bce4a("*TRACE-MD is Processing Your Request...*");
...
king({
  ...
  try {
    if (!_0x181394 || _0x181394 == '') {
      _0x248cc8("*exemple :* " + _0x16cabd + "didong WillisXth");
      return;
    }
...
king({
  ...
  if (!_0xc0638 || _0xc0638 == '') {
    _0x3f898a("  Example :* " + _0x338b80 + "graffiti TRACE-MD");
    return;
  }
  try {
...
king({
  ...
  try {
    ...
    _0x23d127("*TRACE-MD is processing your request...*");
...
king({
  ...
  try {
    if (!_0x1cc29f || _0x1cc29f == '') {
      _0x3d04bb(_0x935ff1 + "gold TRACE-MD");
      return;
    }
...
king({
  ...
  try {
    if (!_0x173395 || _0x173395 == '') {
      _0x45e8bf(_0x305516 + "arena TRACE-MD");
      return;
    }
...
king({
  ...
  try {
    if (!_0x4b58e7 || _0x4b58e7 == '') {
      _0x1db70e(_0x494606 + "incandescent TRACE-MD");
      return;
    }
...
king({
  ...
  try {
    if (!_0x6efe13 || _0x6efe13 == '') {
      _0x35540f(_0x1b0b42 + "child TRACE-MD");
      return;
    }
...
king({
  ...
  try {
    if (!_0x139bd2 || _0x139bd2 == '') {
      _0x132248(_0x5effd2 + "typo TRACE-MD");
      return;
    }
...
king({
  ...
  try {
    if (!_0xfe79e0 || _0xfe79e0 == '') {
      _0x2c714c(_0x46fa4e + "light TRACE-MD");
      return;
    }
...
king({
  ...
  try {
    if (!_0x3aad7c || _0x3aad7c == '') {
      _0x550e81(_0x586e09 + "steel TRACE-MD");
      return;
    }
...
king({
  ...
  try {
    if (!_0x1a407a || _0x1a407a == '') {
      _0x4195f9(_0x155f29 + "sunlight TRACE-MD");
      return;
    }
